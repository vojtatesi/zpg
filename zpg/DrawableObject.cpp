...
DrawableObject::DrawableObject(std::shared_ptr<Model> m, std::shared_ptr<ShaderProgram> s) : model(std::move(m)), shader(std::move(s)), transform(std::make_shared<Transformation>()) {}
